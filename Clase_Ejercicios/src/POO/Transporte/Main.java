...
// Crear instancias de las clases
        Coche coche = new Coche("Automóvil", 0.1, 30.0, 4);
...
// Mostrar detalles de cada medio de transporte
        ...
        System.out.println("Altitud Máxima: " + avion.getAltitudMaxima() + " metros\n");
// Calcular el costo de un viaje de 200 km para cada medio de transporte
        ...
        System.out.println("Costo del viaje en tren: " + tren.calcular_coste_viaje_tren(distanciaViaje) + " euros");
