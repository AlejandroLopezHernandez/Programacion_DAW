...
public class Enano extends Personaje {
    ...
    public Enano(int nivel_vida,int nivel_experiencia,int nivel_destreza,int nivel_ataque,int nivel_personaje) {
    ...
    public void subir_nivel() {
        this.nivel_personaje = this.nivel_experiencia * 0.2 + this.nivel_destreza * 0.3 + this.nivel_ataque * 0.5;
    }
